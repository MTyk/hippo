...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_client_SOURCE_PREFIX /home/pioneer/group41/src/rosserial-hydro-devel/rosserial_client)
  set(rosserial_client_DEVEL_PREFIX /home/pioneer/group41/devel)
  ...
  set(rosserial_client_INSTALL_PREFIX /home/pioneer/group41/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pioneer/group41/install/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>, Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
