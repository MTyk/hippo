...
cd "/home/pioneer/group41/src/rosserial/rosserial_xbee"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/pioneer/group41/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/pioneer/group41/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
