...
cd "/home/pioneer/group41/src/rosserial/rosserial_python"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/pioneer/group41/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/pioneer/group41/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
